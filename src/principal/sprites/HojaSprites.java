...
public class HojaSprites {
	...
	public HojaSprites(final String ruta, final int tamañoSprites, final boolean hojaOpaca){ //asume que los sprites son cuadrados//
	...
	private void rellenarSpritesDesdeImagen(final BufferedImage imagen){ //carga el array con los sprites de la hoja//
	...
	public Sprite obtenerSprite(final int indice){
		return sprites[indice]; //devuelve el sprite de la posicion// 
	}
	
	public Sprite obtenerSprite(final int x, final int y){ //se obtien sprite en la coordenada de la hoaja//
